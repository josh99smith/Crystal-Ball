...
/** A reliability bucket: predictions whose confidence fell in [lo, hi). */
...
export interface CalibrationMetrics {
  resolved: number; // scored predictions
  pending: number; // logged but not yet resolved
  brier: number | null; // mean Brier score (lower is better), null if none
  bands: ReliabilityBand[];
  byCategory: Array<{ category: EventCategory; n: number; hitRate: number }>;
  updatedAt: string;
}
